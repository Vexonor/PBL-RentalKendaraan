...
// Fungsi untuk mengubah sisa waktu dalam detik menjadi format yang sesuai
...
<body>
    <div class="container-fluid">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link  bg-secondary" aria-current="page" href="status.php"
                                    style="border-radius: 50px;">
                                    <img src="assets/speedometer-unscreen.gif" class="mx-3" alt="" width="50"><strong
                                        class="mx-2">STATUS</strong></a>
                                <hr>
                            </li>
                            <li class="nav-item">
        ...
        <!-- Navbar -->
        <center>
            <h2>STATUS <img src="assets/icons8-task.gif" alt=""></h2>
        </center> <br>
        <!-- Status -->
        <div class="container-fluid">
            <div class="row mb-5 py-5  justify-content-around">
                <?php 
                include "koneksi.php";
                            $sql = "SELECT * FROM konfirmasi WHERE user_id= $user_id AND persetujuan =  'Disetujui' ";
                            $query = mysqli_query($koneksi, $sql);
                            if (mysqli_num_rows($query) < 1) : ?>
                <div class="card mb-5">
                    <div class="card-body text-center">
                        <h6>Anda Belum Melakukan Rental kendaraan <img src="assets/letter-x-unscreen.gif" alt=""
                                width="30">
                        </h6>
                    </div>
                </div>
                ...
                <div class="col mb-5 mx-2">
                    <div class="card mx-auto" id="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <?php echo "Rp. "?><?= htmlspecialchars( $value['total_harga'] ) ?><?php echo " /Hari"?>
                            </h5>
                            <div class="mb-2 d-flex justify-content-center" id="btn-status">
                                <ul>
                                    <li><button type=" button" class="btn btn-secondary mb-2"
                                            style="width: 200px; height: 60px;" disabled>
                                            <?php 
                                if(isset($value['aksi']) && $value['aksi'] == 'Start' ){
                                    echo $remainingTimeFormatted;
                                }
                                else{
                                    echo "Kendaraan Sedang Diantar";
                                }
                                ?>
                                        </button></li>
                                </ul>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-box">
                        ...
                        <p>Focalors rent adalah sebuah Aplikasi berbasis web yang di rancang untuk memfasilitasi
                            penyewaan kendaraan dan jasa yang terkait transportasi untuk tujuan seperti
                            keberangkatan ke
                            suatu tempat atau ke luar daerah seperti kunjungan keluarga, rekreasi, mudik, dan
                            lainnya.
                            Aplikasi ini juga memungkinkan konsumen untuk menyewa berbagai jenis kendaraan seperti
                            mobil
                            atau motor.</p>
