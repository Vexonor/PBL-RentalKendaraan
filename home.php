    ...
    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav  justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item active">
                                <a class="nav-link bg-secondary" aria-current="page" href="home.php"
                                    ...
                                    <img src="assets/home-unscreen.gif" class="mx-3" alt="" width="50"><strong
                                        class="mx-2">HOME</strong></a>
                                <hr>
                            </li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block "
                        ...
                        <h5 class="heading" style="padding: 10px 0 0 0;">SELAMAT DATANG <?php echo $nama;?> DI FOCALORS
                            RENT
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-3" style="max-width: 700px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="image/<?php echo $data['gambar']; ?>" class="img-fluid rounded-start"
                                    alt="...">
                            </div>
                            <div class="col-md-8">
        ...
        <div class="container-fluid">
            <div class="row mb-5 py-5  justify-content-around">
                            ...
                            <div class="mb-2 d-flex justify-content-start" id="action-btn">
                                <ul>
                                    ...
                                    <li> <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalConfirm<?= $productID ?>">
                                            Rental
                                        </button></li>
                                </ul>
                            </div>
                ...
                <!-- Detail -->
                <div class="modal fade" id="modalDetail<?= $productID ?>" tabindex="-1"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="simpan_data_konfirmasi.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm"><img
                                                src="assets/price-tag-unscreen.gif" alt="" width="30">Promo
                                        </span>
