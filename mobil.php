...
<body>
    <div class="container-fluid">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item  dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item active bg-secondary mx-2" href="mobil.php"
                                            style="border-radius: 50px; width: 230px;"><img
                                                src="assets/car-unscreen.gif" class="mx-2" alt="" width="50"><strong
                                                class="mx-4">MOBIL</strong></a>
        ...
        <!-- Navbar -->
        <center>
            <h2>GET YOUR CAR <img src="assets/icons8-car.gif" alt=""></h2>
        </center> <br>
        <!-- Produk -->
        <div class="container-fluid">
            <div class="row mb-5 py-5  justify-content-around">
                ...
                <div class="col mb-5 mx-2">
                    <div class="card mx-auto <?= $isDisabled ?>" id="card" style="width: 18rem; <?= $opacity ?>">
